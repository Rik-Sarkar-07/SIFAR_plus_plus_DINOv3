...
class VideoDataSet(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # print("Type of the images = ",type(images))     # List of PIL Images
        # print("The len of the images = ",len(images))   # 8 PIL images
        # print("The len of the images[0] = ",(images[0]).size)   # (454, 256)
        # images[0].save("Test.png")                              # goodlooking image
        # exit(0)
        ...
        """
        print(images.shape)             # [24, 224, 224]    8 images with 3 channels and dim of 224x224
        check = images.reshape(8,224,224,3)[0].permute(2,0,1)
        import torchvision.transforms as transforms
        trans_pil = transforms.ToPILImage()
        target_image = trans_pil(check)
        target_image.save("check.png")
        exit(0)
